    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('WorkingHour', models.DecimalField(decimal_places=2, max_digits=5)),
                ('empId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_view.employeetable')),
            ],
        ),
    ]
